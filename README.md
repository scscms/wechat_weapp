...
- [IDE + 破解 + Demo(gavinkwoe/weapp-ide-crack) 只安装0.9版本即可使用](https://github.com/gavinkwoe/weapp-ide-crack)
- [官方IDE window 64位 ](http://pan.baidu.com/s/1kVDEaDh) 提取密码：t2tj
- [官方IDE window 32位 ](http://pan.baidu.com/s/1bHJRWU) 提取密码：sbke
